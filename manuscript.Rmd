...
Results from this sample were not double-checked and so may have a small number of inaccuracies.
...
As some articles included more than one enrichment analysis, the dataset included 235 analyses from 186 articles (Supplementary Table 1).
...
From 109 analyses, just 28 studies performed stated they performed separate analysis of up- and down-regulated gene sets.
...
![Figure S1a. Representation of journals in the data set.](images/journals2.png "Journals")

![Figure S1B. Representation of different omics types in the data set.](images/omics2.png "Omics")

![Figure S1C. Representation of different organisms in the data set.](images/organisms2.png "Organisms")

![Figure 3A. Representation of different gene set libraries in the data set.](images/genesetlib2.png "Geneset libraries")

![Figure 3B. Proportion of analyses that reported version information for gene sets used.](images/genesetvers2.png "Geneset version")

![Figure 3C. Representation of different statistical tests in the data set.](images/stattest2.png "Geneset libraries")

![Figure 3D. Recognition of p-value correction for multiple testing in the data set.](images/fdr2.png "FDR")

![Figure 3E. Representation of different software tools for enrichment analysis in the data set.](images/app2.png "Software used")

![Figure 3F. Proportion of analyses that reported version information for software used.](images/appvers2.png "Software version")

![Figure 3G. Background gene set usage and reporting in the dataset.](images/bg2.png "Background gene list used")

![Figure 3H. Proportion of scripted analyses that provided software code.](images/code2.png "Code available")

![Figure 3I. Proportion of scripted analyses that provided gene profiles.](images/genelists2.png "Gene lists provided")

![Figure 3J. Proportion of analyses with different methodological problems.](images/assumptions2.png "Assumptions violated")

![Figure 3K. Representation of journals in the data set.](images/comb2.png "Journals")

![Figure 3L. Reporting of GSEA parameters.](images/gseaparam2.png "Journals")
...
We therefore analysed a further 1300 articles, bringing the total number of analyses described up to 1365. 
This larger sample did not undergo double-checking so may contain a small number of errors.
...
![Figure 4E. Association between SJR and mean analysis score for journals with 5 or more analyses.](images/mean_sjr1.png "Mean score vs SJR")

![Figure 4F. Association between SJR and citations.](images/cites1.png "Mean score vs citations")


## Discussion

While there have been several articles benchmarking the performance of functional enrichment tools, there has been relatively little interest in how existing tools are (mis)used. 
A recent study looked at the the popularity of frequently used tools and their performance (Xie et al, 2021), but this assumes that the tools were properly used and sufficiently reported.
...
Results shown here indicate that a large fraction of published works suffer from a high rate of false negatives, in effect missing a large fraction of truly differentially regulated gene sets.
...
Surprisingly, the analysis scores we generated did not correlate with journal level bibliographic metric, nor accrued citations of individual articles, showing no association between methodological rigour and traditional research impact metrics in this sample.
This suggests that methodological and reporting problems are not limited lower ranked journals, but are a more general problem.
...
These tools are best used generating new hypotheses; informing subsequent biochemical or signaling experimentation.
