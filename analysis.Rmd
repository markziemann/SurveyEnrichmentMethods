...
## Filter for studies included in QC2
...
plot(xm$SJR,xm$scores, col = rgb(red=0,blue=0,green=0,alpha=0.2), pch=19,
...
plot(jjres$SJR,jjres$scores,col = rgb(red=0,blue=0,green=0,alpha=0.2) , pch=19,
...
plot(xm$cites,xm$scores, col = rgb(red=0,blue=0,green=0,alpha=0.2) , pch=19,
...
plot(log2(xm$cites),xm$scores, col = rgb(red=0,blue=0,green=0,alpha=0.2) , pch=19,
