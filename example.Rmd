...
d_de <- enricher(gene = LGvHG_de, universe = LGvHG_bg, TERM2GENE = genesets2)
d_de <- head(d_de,1000)
...
e_de <- enricher(gene = LGvHG_de, universe = LGvHG_bg, TERM2GENE = genesets2)
e_de <- head(e_de,1000)
head(e_de)
...
dat <- c("ORA vs ORA comb"=dc,"FCS vs ORA"=cm,"ORA vs ORA*"=cf,"FCS vs ORA*"=mf)
